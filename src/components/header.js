    ...
    this.innerHTML = `
        <header class="flex justify-between items-center h-16 bg-white px-6 border-b border-slate-200 shadow-sm z-10">
            ...
            <div class="flex items-center space-x-3">
              <!-- Icono/Logo FOCO -->
              <div class="w-12 h-12 rounded-full bg-foco-blue-deep flex items-center justify-center text-white font-bold text-sm shadow-md overflow-hidden p-2">
                <img src="${logoSvg}" alt="F.O.C.O. Logo" class="w-full h-full object-contain">
              </div>
              <div>
